  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="mb-3">
          {isCreatingTag ? (
            ...
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-2 text-left text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/30 hover:bg-blue-100 dark:hover:bg-blue-950/50 rounded-lg border border-blue-200 dark:border-blue-800 transition-colors duration-200"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Tags Grid */}
        {tags.length === 0 ? (
          <div className="text-center py-6 text-neutral-500 dark:text-neutral-400 text-sm bg-neutral-50 dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700">
            No tags available
          </div>
        ) : (
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 max-h-48 overflow-y-auto">
            {tags.map((tag) => (
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2 text-left rounded-lg border transition-all duration-200 ${
                  selectedTagIds.includes(tag.id)
                    ? 'bg-blue-50 dark:bg-blue-950/50 border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300 shadow-sm'
                    : 'bg-white dark:bg-neutral-800 border-neutral-200 dark:border-neutral-700 text-neutral-900 dark:text-neutral-100 hover:bg-neutral-50 dark:hover:bg-neutral-700 hover:border-neutral-300 dark:hover:border-neutral-600'
                }`}
              >
                <div
